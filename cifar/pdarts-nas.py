...
from pdarts import genotypes
from pdarts.model import NetworkCIFAR as Network
import pandas as pd
...
parser.add_argument('-c', '--checkpoint_dir', default='../pdarts/pretrained/', type=str,
...
parser.add_argument('--restarts', default=1, type=int,
                    help='specify number of restarts for PGD/AutoPGD, default: 1')
...
print("Average acc of AutoPGD-10 on P-DARTS: {}".format(apgd))   
# if args.to_csv:
#     try:
...
#         print("Run {} Average acc on {} starts of PGD on {}: {}".format(run, n_repeats, 'pdarts', pgd_accs[n_repeats]))

#         apgd = apgd_attack_cifar(net, testloader, args.eps, args.iters, n_repeats)
#         apgd_accs[n_repeats] = apgd
#         print("Run {} Average acc on {} starts of AutoPGD on {}: {}".format(run, n_repeats, 'pdarts', apgd))    
...
# df.to_csv('pdarts_cifar10.csv', index=False)
